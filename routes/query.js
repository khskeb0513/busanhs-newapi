...
require('../demo/student');
require('../demo/studentin');
...
router.get('/arrived', (req, res, next) => {
    const query = {
...
router.get('/arrived/add', (req, res, next) => {
    res.redirect('/query')
})

router.post('/arrived/add', (req, res, next) => {
    const body = {
...
router.get('/arrived/delete', (req, res, next) => {
    const query = {
